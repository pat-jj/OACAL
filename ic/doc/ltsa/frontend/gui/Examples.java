...
public class Examples {
    ...
    public void getExamples() {
        ...
        List<String> chapters = getContents("examples/contents.txt");
        Iterator<String> i = chapters.iterator();
        while (i.hasNext()) {
            String s = i.next();
            JMenu chapter = new JMenu(s.substring(0, s.indexOf('_')));
            parent.add(chapter);
            List<String> examples = getContents("examples/" + s + "/contents.txt");
            ...
            while (j.hasNext()) {
                ...
                example.addActionListener(new ExampleAction("examples/" + s + "/", es));
                chapter.add(example);
            }
        }
    }
